...
async def command_start(message: Message, state: FSMContext):
    ...
    print('15. разберись с бот делит мессаж, сделай проверку на инт условие')
    print('16. в случае на нашел таскс и медиа в бд - пусть в ошибке пишет кто и что искал')
    print('17. результат равен фолсе или функция, а то иначе будет плюс при остутсвтии добавления')
    print('18. не работает ревижн источников, пишет не слов и выводит все')
    print('19. сейчас заданий 0, добавляю из ревижн - остается 0')
    print('20. подумай над перезагрузкой 1 раз в сутки')
    # чистим стейт
    await state.clear()
